...
function Page1() {
  return (
    ...
    <section className="container overflow-hidden ml-32 w-2/5 absolute top-16 md:ml-64 w-3/5 p-6 font-poppins">
    ...
    <div className="w-full overflow-x-auto ">
      ...
      <thead>
        ...
        <tbody className="bg-[#0B0B45]">
        
          <tr className="text-white">
          <td className="px-4 py-3 border">
              <div className="flex items-center text-sm">
                <div className="relative w-8 h-8 mr-3 rounded-full md:block">
                  <img className="object-cover w-full h-full rounded-full" src={img1} alt="" loading="lazy" />
            ...
            <td className="px-4 py-3 text-xs border">Lorem, ipsum dolor sit amet consectetur adipisicing<br/> elit. Vel quaerat pariatur praesentium totam?</td>
            <td className="px-4 py-3 text-xs border">
              <span className="px-2 py-1 font-semibold leading-tight text-white rounded-sm"> Active Bid </span>
            </td>
          ...
          <tr className="text-white">
            ...
            <td className="px-4 py-3 text-xs border">
              <span className="px-2 py-1 font-semibold leading-tight text-white rounded-sm">  </span>
            </td>
          ...
          <tr className="text-white">
            <td className="px-4 py-3 border">
              <div className="flex items-center text-sm">
                <div className="relative w-8 h-8 mr-3 rounded-full">
                  <img className="object-cover w-full h-full rounded-full" src={img2} alt="" loading="lazy"/>
                  <div className="absolute inset-0 rounded-full shadow-inner" aria-hidden="true"></div>
                </div>
                <div>
          ...
          <tr className="text-white">
            <td className="px-4 py-3 border">
              <div className="flex items-center text-sm">
                <div className="relative w-8 h-8 mr-3 rounded-full">
                  <img className="object-cover w-full h-full rounded-full" src={img3} alt="" loading="lazy" />
                  <div className="absolute inset-0 rounded-full shadow-inner" aria-hidden="true"></div>
                </div>
                <div>
            ...
            <td className="px-4 py-3 border text-xs">Lorem, ipsum dolor sit amet consectetur adipisicing<br/> elit. Vel quaerat pariatur praesentium totam?</td>
            <td className="px-4 py-3 border text-xs">
              <span className="px-2 py-1 font-semibold leading-tight text-white rounded-sm"> Upcoming</span>
            </td>
            {/* <td className="px-4 py-3 border text-sm">6/10/2020</td> */}
          </tr>
          <tr className="text-white">
          ...
          <tr className="text-white">
            <td className="px-4 py-3 border">
              <div className="flex items-center text-sm">
                <div className="relative w-8 h-8 mr-3 rounded-full">
                  <img className="object-cover w-full h-full rounded-full" src={img4} alt="" loading="lazy" />
                  <div className="absolute inset-0 rounded-full shadow-inner" aria-hidden="true"></div>
                </div>
                <div>
            ...
            <td className="md:px-4 py-3 border text-xs">
              <span className="px-2 py-1 font-semibold leading-tight text-white rounded-sm"> Finished </span>
            </td>
            {/* <td className="px-4 py-3 border text-sm">6/10/2020</td> */}
          </tr>
